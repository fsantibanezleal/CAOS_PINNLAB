...
PINN-Lab is a runnable catalogue of ~20 partial-differential-equation cases, each trained offline by a
state-of-the-art Physics-Informed Neural Network engine, validated against an analytic/FEM reference, exported to
