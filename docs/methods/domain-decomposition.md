...
> **Exercised by:** `mine-heap-leach-rt` (in progress) (cPINN/XPINN) · `poll-soil-barrier` (shipped) (FBPINN)
...
| Exercised by | `mine-heap-leach-rt` (in progress) | `poll-soil-barrier` (shipped) |
