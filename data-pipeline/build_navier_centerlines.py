                ...
                "series": [
                    {
                        ...
                        "color": "var(--muted)",
                        "scatter": True,
                        "x": [round(float(y), 4) for y in GHIA_U_Y],
                        "y": [round(float(uu), 4) for uu in GHIA_U],
                    },
                    {
                        "label": "PINN",
                        "color": "var(--good)",
                        "x": [round(float(y), 4) for y in ay],
                        "y": [round(float(uu), 4) for uu in u_center],
                    },
                ],
            },
            {
                ...
                "series": [
                    {
                        ...
                        "color": "var(--muted)",
                        "scatter": True,
                        "x": [round(float(x), 4) for x in GHIA_V_X],
                        "y": [round(float(vv), 4) for vv in GHIA_V],
                    },
                    {
                        "label": "PINN",
                        "color": "var(--good)",
                        "x": [round(float(x), 4) for x in ax],
                        "y": [round(float(vv), 4) for vv in v_center],
                    },
                ],
            },
        ],
