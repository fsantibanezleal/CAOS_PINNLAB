...
All notable changes to this product. Format: `X.XX.XXX` (display) — see `pinnlab.__version__`. Keep `0.x`
...
- Offline `data-pipeline/` (`pinnlab`): the two data contracts (ingestion + artifact), the named staged
