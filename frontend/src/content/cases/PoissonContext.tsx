  ...
  return es ? (
    <>
      ...
      <p>
        ...
        <InlineMath tex={String.raw`k\in[1,3]`} />, una red FNN tanh entrenada Adam, luego L-BFGS. La restricción dura
      ...
      <p>
        ...
        en viridis; al pasar el cursor se lee el valor exacto en cualquier punto (aparecen la cruz, las coordenadas y
        <InlineMath tex={String.raw`u`} />) y se muestran los dos <strong>perfiles de corte</strong> (u a lo largo de x y de y
        por el cursor). Los <strong>chips de régimen</strong> cargan cada modo precalculado; el tab <strong>Charts</strong>
        compara el L2 de todos (clic para cargar). En el tab <strong>Live</strong>, al mover el deslizador de
        <InlineMath tex={String.raw`k`} /> el campo se <em>recalcula en vivo</em> en el navegador vía onnxruntime-web
    ...
    <>
      ...
      <p>
        ...
        <InlineMath tex={String.raw`k\in[1,3]`} />, a tanh FNN trained Adam then L-BFGS. The hard constraint survives the
      ...
      <p>
        ...
        <InlineMath tex={String.raw`k`} /> slider and the field <em>recomputes live</em> in the browser via
